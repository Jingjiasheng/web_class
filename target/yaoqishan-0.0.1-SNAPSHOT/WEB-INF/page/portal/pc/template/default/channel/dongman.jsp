		...
		<div class="block no-shadow">
			<div class="fenlei">
				<ul class="n_num">
					...
					<li><a href="${pageContext.request.contextPath}/portal/list.action?typeId=1&name=风格&value=语文" target="_blank">语文</a></li>
					<li><a href="${pageContext.request.contextPath}/portal/list.action?typeId=1&name=风格&value=数学" target="_blank">数学</a></li>
					<li><a href="${pageContext.request.contextPath}/portal/list.action?typeId=1&name=风格&value=英语" target="_blank">英语</a></li>
					<li><a href="${pageContext.request.contextPath}/portal/list.action?typeId=1&name=风格&value=历史" target="_blank">历史</a></li>
					<li><a href="${pageContext.request.contextPath}/portal/list.action?typeId=1&name=风格&value=医学" target="_blank">医学</a></li>
					<li><a href="${pageContext.request.contextPath}/portal/list.action?typeId=1&name=风格&value=地理" target="_blank">地理</a></li>
					<li><a href="${pageContext.request.contextPath}/portal/list.action?typeId=1&name=风格&value=生物" target="_blank">生物</a></li>
					<li><a href="${pageContext.request.contextPath}/portal/list.action?typeId=1&name=风格&value=物理" target="_blank">物理</a></li>
					<li><a href="${pageContext.request.contextPath}/portal/list.action?typeId=1&name=风格&value=化学" target="_blank">化学</a></li>
					<li><a href="${pageContext.request.contextPath}/portal/list.action?typeId=1&name=风格&value=音乐" target="_blank">音乐</a></li>
					<li><a href="${pageContext.request.contextPath}/portal/list.action?typeId=1&name=风格&value=体育" target="_blank">体育</a></li>
					<li><a href="${pageContext.request.contextPath}/portal/list.action?typeId=1&name=风格&value=美术" target="_blank">美术</a></li>
					<li><a href="${pageContext.request.contextPath}/portal/list.action?typeId=1&name=风格&value=编程" target="_blank">编程</a></li>
					<li><a href="${pageContext.request.contextPath}/portal/list.action?typeId=1&name=风格&value=法律" target="_blank">法律</a></li>
...
<script>
	...
	$(function() {
		...
		// 最新番剧
		loadData("tab1_0", "api/data.json?apiId=201");
		// 周一更新
		loadData("tab1_1", "api/data.json?apiId=202");
		// 周二更新
		loadData("tab1_2", "api/data.json?apiId=203");
		// 周三更新
		loadData("tab1_3", "api/data.json?apiId=204");
		// 周四更新
		loadData("tab1_4", "api/data.json?apiId=205");
		// 周五更新
		loadData("tab1_5", "api/data.json?apiId=206");
		// 周六更新
		loadData("tab1_6", "api/data.json?apiId=207");
		// 周日更新
		loadData("tab1_7", "api/data.json?apiId=208");
		
		// 新闻速览
		getOverData();
		
		// 小编力推
		getDataByTag("jiufan", "api/data.json?apiId=212");
		
		// 趣味一课
		getDataByTag("youzhiguochan", "api/data.json?apiId=213");
		
		// 幼儿智力
		getDataByTag("tuili", "api/data.json?apiId=214");
		
		// 每日一学
		// 每日英语
		getDataByTag2("tab2_1_1", "tab2_1_2", "api/data.json?apiId=221");
		// 每日语文
		getDataByTag2("tab2_2_1", "tab2_2_2", "api/data.json?apiId=222");
		// 每日政治
		getDataByTag2("tab2_3_1", "tab2_3_2", "api/data.json?apiId=223");
		// 每日数学
		getDataByTag2("tab2_4_1", "tab2_4_2", "api/data.json?apiId=224");
		// 每日学法
		getDataByTag2("tab2_5_1", "tab2_5_2", "api/data.json?apiId=225");
		// 每日防疫
		getDataByTag2("tab2_6_1", "tab2_6_2", "api/data.json?apiId=226");
		// 每日历史
		getDataByTag2("tab2_7_1", "tab2_7_2", "api/data.json?apiId=227");
	...
	function huandeng() {
		$.ajax({
			url : path + "api/slide.json?apiId=1100",
			type : "POST",
			dataType : "json",
	...
	function getOverData() {
		$.ajax({
			url : path + "api/data.json?apiId=211",
			type : "POST",
			dataType : "json",
			success : function(rtn) {
				if (rtn.code=="999999") {
