...
<div id="nav" class="admin-iframe-header">
	<h1 class="logo"><a href="javascript:;">沐课后台管理</a></h1>
	<div class="admin-iframe-nav">
		<ul class="navs">
			...
			<li class="nav"><a href="${pageContext.request.contextPath}/admin/content.action">课程</a></li>
			<li class="nav"><a href="${pageContext.request.contextPath}/admin/api.action">接口</a></li>
			<li class="nav"><a href="${pageContext.request.contextPath}/admin/founder.action">邮件收发</a></li>
		</ul>
	</div>
	...
	<div class="admin-iframe-header-right">
		<ul class="navs">
			...
			<li class="nav"><a href="${pageContext.request.contextPath}/" target="_blank">前台首页</a></li>
		</ul>
	</div>
</div>
