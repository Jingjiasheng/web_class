...
public class AdminAction {
	...
	public Result login(HttpServletRequest request) throws Exception {
		...
		if (!"管理员".equals(userInfo.getGroupName())) {
			System.out.println("组名：-> "+userInfo.getGroupName());
			throw new QingException(ErrorMsg.ERROR_100002);
		}
	...
	public String center(ModelMap map) {
		...
		sb.append("	<div class='right'>j_jiasheng@qq.com</div>");
		sb.append("	<span class='clearfix'></span>");
		sb.append("</div>");
		sb.append("<div class='unit'>");
	...
	public String service(ModelMap map) {
		...
		sb.append("</div>");
		sb.append("<div class='unit'>");
		sb.append("	<div class='left'><p class='subtitle'>编程时长</p></div>");
		sb.append("	<div class='right'>3年</div>");
		sb.append("	<span class='clearfix'></span>");
		sb.append("</div>");
		sb.append("<div class='unit'>");
		sb.append("	<div class='left'><p class='subtitle'>爱好</p></div>");
		sb.append("	<div class='right'>code</div>");
		sb.append("	<span class='clearfix'></span>");
		sb.append("</div>");
		sb.append("<div class='unit'>");
		sb.append("	<div class='left'><p class='subtitle'>联系方式：</p></div>");
