		...
		<div class="block no-shadow">
			<div class="fenlei">
				<ul class="n_num">
					...
					<li><a href="${pageContext.request.contextPath}/portal/list.action?typeId=4&name=类型&value=语文" target="_blank">语文</a></li>
					<li><a href="${pageContext.request.contextPath}/portal/list.action?typeId=4&name=类型&value=数学" target="_blank">数学</a></li>
					<li><a href="${pageContext.request.contextPath}/portal/list.action?typeId=4&name=类型&value=英语" target="_blank">英语</a></li>
					<li><a href="${pageContext.request.contextPath}/portal/list.action?typeId=4&name=类型&value=历史" target="_blank">历史</a></li>
					<li><a href="${pageContext.request.contextPath}/portal/list.action?typeId=4&name=类型&value=医学" target="_blank">医学</a></li>
					<li><a href="${pageContext.request.contextPath}/portal/list.action?typeId=4&name=类型&value=地理" target="_blank">地理</a></li>
					<li><a href="${pageContext.request.contextPath}/portal/list.action?typeId=4&name=类型&value=生物" target="_blank">生物</a></li>
					<li><a href="${pageContext.request.contextPath}/portal/list.action?typeId=4&name=类型&value=物理" target="_blank">物理</a></li>
					<li><a href="${pageContext.request.contextPath}/portal/list.action?typeId=4&name=类型&value=化学" target="_blank">化学</a></li>
					<li><a href="${pageContext.request.contextPath}/portal/list.action?typeId=4&name=类型&value=音乐" target="_blank">音乐</a></li>
					<li><a href="${pageContext.request.contextPath}/portal/list.action?typeId=4&name=类型&value=体育" target="_blank">体育</a></li>
				</ul>
			</div>
			<div class="main">
...
<script>
	...
	$(function() {
		...
		// 新闻速览
		loadData("yugao_left", "yugao_right", "api/data.json?apiId=300");
		
		// 趣味知识
		getDataByTag("zuixin", "api/data.json?apiId=301");
		
		// 快乐分享
		getDataByTag("tegong", "api/data.json?apiId=302");
		
		// 耳畔回音
		getDataByTag("dushi", "api/data.json?apiId=303");
		
		// 来份鸡汤
		getDataByTag("dongzuo", "api/data.json?apiId=304");
		
		// 独家策划
		// 玫瑰之约
		getDataByTag2("tab2_1_1", "tab2_1_2", "api/data.json?apiId=310");
		// 拯救不开心
		getDataByTag2("tab2_2_1", "tab2_2_2", "api/data.json?apiId=311");
		// 男神女神
		getDataByTag2("tab2_3_1", "tab2_3_2", "api/data.json?apiId=312");
		// 无忧童心
		getDataByTag2("tab2_4_1", "tab2_4_2", "api/data.json?apiId=313");
		// 烧脑穿越
		getDataByTag2("tab2_5_1", "tab2_5_2", "api/data.json?apiId=314");
		// 奇幻大片
		getDataByTag2("tab2_6_1", "tab2_6_2", "api/data.json?apiId=315");
	...
	function huandeng() {
		$.ajax({
			url : path + "api/slide.json?apiId=1101",
			type : "POST",
			dataType : "json",
