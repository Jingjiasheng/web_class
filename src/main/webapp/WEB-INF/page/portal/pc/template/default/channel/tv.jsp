		...
		<div class="block no-shadow">
			<div class="fenlei">
				<ul class="n_num">
					...
					<li><a href="${pageContext.request.contextPath}/portal/list.action?typeId=3&name=类型&value=语文" target="_blank">语文</a></li>
					<li><a href="${pageContext.request.contextPath}/portal/list.action?typeId=3&name=类型&value=数学" target="_blank">数学</a></li>
					<li><a href="${pageContext.request.contextPath}/portal/list.action?typeId=3&name=类型&value=英语" target="_blank">英语</a></li>
					<li><a href="${pageContext.request.contextPath}/portal/list.action?typeId=3&name=类型&value=历史" target="_blank">历史</a></li>
					<li><a href="${pageContext.request.contextPath}/portal/list.action?typeId=3&name=类型&value=医学" target="_blank">医学</a></li>
					<li><a href="${pageContext.request.contextPath}/portal/list.action?typeId=3&name=类型&value=地理" target="_blank">地理</a></li>
					<li><a href="${pageContext.request.contextPath}/portal/list.action?typeId=3&name=类型&value=生物" target="_blank">生物</a></li>
					<li><a href="${pageContext.request.contextPath}/portal/list.action?typeId=3&name=类型&value=物理" target="_blank">物理</a></li>
					<li><a href="${pageContext.request.contextPath}/portal/list.action?typeId=3&name=类型&value=化学" target="_blank">化学</a></li>
					<li><a href="${pageContext.request.contextPath}/portal/list.action?typeId=3&name=类型&value=音乐" target="_blank">音乐</a></li>
					<li><a href="${pageContext.request.contextPath}/portal/list.action?typeId=3&name=类型&value=体育" target="_blank">体育</a></li>
					<li><a href="${pageContext.request.contextPath}/portal/list.action?typeId=3&name=类型&value=美术" target="_blank">美术</a></li>
					<li><a href="${pageContext.request.contextPath}/portal/list.action?typeId=3&name=类型&value=编程" target="_blank">编程</a></li>
					<li><a href="${pageContext.request.contextPath}/portal/list.action?typeId=3&name=类型&value=法律" target="_blank">法律</a></li>
				</ul>
			</div>
			<div class="main">
...
<script>
	...
	$(function() {
		...
		// 最新预告
		loadData2("newest_left", "newest_right", "api/data.json?apiId=100");
		
		// 连载中...
		getDataByTag("internet_drama", "api/data.json?apiId=101");
		
		// 人气课程
		loadData2("over_data_left", "over_data_right", "api/data.json?apiId=102");
		
		// 近期结课
		getDataByTag("idols", "api/data.json?apiId=103");
		
		// 人气老师
		loadData2("yingmei_left", "yingmei_right", "api/data.json?apiId=104");
		
		// 其他待定
		loadData("rihan", "api/data.json?apiId=105");
		
		// 独家策划
		// 文学专访
		getDataByTag2("tab2_1_1", "tab2_1_2", "api/data.json?apiId=110");
		// 音乐专访
		getDataByTag2("tab2_2_1", "tab2_2_2", "api/data.json?apiId=111");
		// 语言专访
		getDataByTag2("tab2_3_1", "tab2_3_2", "api/data.json?apiId=112");
		// 科学专访
		getDataByTag2("tab2_4_1", "tab2_4_2", "api/data.json?apiId=113");
		// 智力专访
		getDataByTag2("tab2_5_1", "tab2_5_2", "api/data.json?apiId=114");
		// 心理专访
		getDataByTag2("tab2_6_1", "tab2_6_2", "api/data.json?apiId=115");
		// 数学专访
		getDataByTag2("tab2_7_1", "tab2_7_2", "api/data.json?apiId=116");
	...
	function huandeng() {
		$.ajax({
			url : path + "api/slide.json?apiId=1102",
			type : "POST",
			dataType : "json",
